    ...
    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                ...
                <li class="breadcrumb-item text-muted">
                    <a href="{{ route('admin.periode-monitoring.index') }}" class="text-muted text-hover-primary">Periode Monitoring</a>
                </li>
                <li class="breadcrumb-item">
                    <span class="bullet bg-gray-400 w-5px h-2px"></span>
                </li>
                ...
                <form action="{{ route('admin.periode-monitoring.store') }}" method="POST">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <select name="semester_akademik" class="form-select form-select-solid" required>
                            ...
                            <option value="ganjil" {{ old('semester_akademik') == 'ganjil' ? 'selected' : '' }}>Ganjil</option>
                            <option value="genap" {{ old('semester_akademik') == 'genap' ? 'selected' : '' }}>Genap</option>
                        </select>
                    </div>
                    <!--end::Input group-->
